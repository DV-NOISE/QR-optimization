...
def encode_data(data_bytes, output_img, size=160, cell_size=5):
    ...
    for pos in positions:
        ...
        # Let's adjust the mapping to be more direct.
        # Total cells available for data: size*size - 32
        # We'll use a simple linear mapping for now.
        # This part of your original code had a slight bug where row calculation
        # could overwrite the metadata row if pos was small. Let's correct it.
        # The first data-storing cell is (0, 32).
